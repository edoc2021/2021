    ...
    return (
      <Layout location={this.props.location}>
        <Container>
          ...
          <p>
            The selected workshops would provide a fertile ground for many interesting discussions and productive
            proposals for new industry and research projects, leading to what promises to be an exceptional workshop
            programme.
          </p>
          {/*<p>*/}
